...
class VitsModel(pl.LightningModule):
    ...
    def training_step(self, batch: Batch, batch_idx: int):
        # Manuelle Optimierung aktivieren
        opt_g, opt_d = self.optimizers()

        # Schritt 1: Generator-Forward und Loss
        ...
        # Schritt 2: Discriminator-Forward und Loss
        ...
        # Logging (optional)
        self.log("train_loss_gen", loss_g, prog_bar=True)
        self.log("train_loss_disc", loss_d, prog_bar=True)
